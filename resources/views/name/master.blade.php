        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item @yield('boys_name')">
                    <a class="nav-link" href="{{route('boys')}}">{{__("Boys Name")}} <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item @yield('girls_name')">
                    <a class="nav-link" href="{{route('girls')}}">{{__("Girls Name")}}</a>
                </li>
            </ul>
            <div class="login">
                @if(!Auth::user())
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 footer-bottom-text text-center">
                <p>Copyright &copy {{ now()->year }}. All rights reserved<a href="#"></a>.</p>
            </div>
        </div>
    </div>
</section>
