        ...
        <div class="container">
            <div class="row">
                <div class="col-12 title">
                    <a href="{{ url('/') }}"><span>{{__('Home')}}</span> </a><a href="name-details.html"> > {{ $name->name }}</a>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div class="name-text">
                                <div class="col-12">
                                    <div class="row details-name">
                                        <div class="col-3 pl-0"><p>{{__('Gender')}}</p></div>
                                        <div class="col-9 pr-0"><span>: {{($name->gender == 1)? __("Male"):__("Female")}}</span></div>
                                    </div>
{{--                                    <div class="row details-name">--}}
...
{{--                                    </div>--}}
                                    <div class="row details-name">
                                        <div class="col-3 pl-0"><p>{{__('Meaning')}}</p></div>
                                        <div class="col-9 pr-0"><span>: {{$name->ukrainian_meaning}}</span></div>
                                    </div>
                                    <div class="row details-name">
                                        <div class="col-3 pl-0"><p>{{__('English transliteration')}}</p></div>
                                        <div class="col-9 pr-0"><span>: {{ucfirst($name->slug)}}</span></div>
                                    </div>
                                    @if($name->famous)
                                        <div class="row details-name">
                                            <div class="col-3 pl-0"><p>{{__('Famous peoples')}} <b>{{$name->name}}</b></p></div>
                                            <div class="col-9 pr-0"><span>: {{$name->famous}}</span></div>
                                        </div>
                                    @endif
                                    @if($name->variations)
                                        <div class="row details-name">
                                            <div class="col-3 pl-0"><p>{{__('Variations of name')}} <b>{{$name->name}}</b></p></div>
                                            <div class="col-9 pr-0"><span>: {{$name->variations}}</span></div>
                                        </div>
                                    @endif
                                    <div class="row details-name">
